<template>
    <div>
        ...
        <div class="pd-lr-15">
            <div class="goods flexbox">
                ...
                <div class="flex-1">
                    ...
                    <div>该新品官方价格¥6000.00</div>
                </div>
            </div>
            <div>目前销售价格<span class="fc-red">¥6000.00</span></div>
        </div>
        ...
        <div class="bgc mar-b-10">
            <template v-if="selected==0">
            <div class="flex-jc-between border-b"><span>租金可抵消费额度</span><span>¥3000.00</span></div>
            <div class="flex-jc-between border-b"><span>可拿到货时间</span><span>1-3天</span></div>
            <div class="flex-jc-between border-b"><span>享受优惠</span><span>-¥50.00</span></div>
            </template>
            <div class="flex-jc-between border-b" v-show="selected==1"><span>租金可抵消费额度</span><span>¥2050.00</span></div>
            <div class="flex-jc-between border-b"><span>应付总额</span><span class="fc-red">¥2050.00</span></div>
        </div>
        ...
        <div style="padding:0 10px"><div class="btn text-c">支付</div></div>
