  ...
  <div>
    ...
    <div class="mar-b-10 main">
      ...
      <template v-if="typenum==0">
        <van-cell is-link center @click="go(`/locationList/prebuy/${goodid}`)">
          <template slot="title">
            <div>自取地点</div>
...
export default {
  ...
  data() {
    return {
      ...
      typenum: 0,
      timetext: "",
      getdate: this.$route.query.date,//自取时间
      expectdate: this.$route.query.date, //期望收到日期
      people: "",
      getlocation: "",
      getaddress: "",
      couponstext: "", //优惠券
  ...
  activated() {
     if(!this.$route.meta.isBack || this.isFirstEnter){
        ...
        this.typenum = 0
        this.timetext = ""
        this.getdate = this.$route.query.date//自取时间
        this.expectdate = this.$route.query.date //期望收到日期
        this.people = ""
        this.getlocation = ""
        this.getaddress = ""
